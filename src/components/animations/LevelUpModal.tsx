...
export function LevelUpModal() {
  ...
  useEffect(() => {
    const handler = (e: CustomEvent<LevelUpData>) => setData(e.detail)
    window.addEventListener('jl:levelup', handler as EventListener)
    return () => window.removeEventListener('jl:levelup', handler as EventListener)
  }, [])
