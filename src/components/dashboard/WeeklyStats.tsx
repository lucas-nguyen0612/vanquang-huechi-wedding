...
import type { WeeklyData } from '@/features/gamification/dashboard-queries'
...
export const WeeklyStats: FC<WeeklyStatsProps> = ({ thisWeek, lastWeek }) => {
  const now = new Date()
  ...
  return (
    ...
    >
      ...
      >
        <MiniStatCard
          label="Pomodoros"
          value={String(thisWeek.pomodoros)}
          delta={formatDelta(thisWeek.pomodoros, lastWeek.pomodoros)}
          sparkData={thisWeek.dailyPomodoros}
        />
        <MiniStatCard
          label="Focus time"
